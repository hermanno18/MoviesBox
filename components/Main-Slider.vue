<template>
  <div class="flex items-stretch justify-center h-64 relative bg-secondary aspect-video w-full">
      ...
      <div v-show="!isFetching" class="swiper-wrapper">
        <div v-for=" (item, i) in items" :key="i" class="swiper-slide w-full h-full">
          <div class="relative w-full h-full">
            <div class="absolute h-full z-20 w-full text-white bg-gradient-to-r from-secondary via-[#141414a9] bg-opacity-30 flex items-center">
    ...
    <div v-show="!isFetching" class="swiper-button-prev overflow-hidden border-primary hover:bg-slate-700 border-2 rounded-full"></div>
