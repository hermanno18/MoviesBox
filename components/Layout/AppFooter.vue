<template>
    <div>
        <div class="text-center pb-4 container mx-auto text-gray-500 text-sm mt-4 ">
            <div class="md:flex justify-between items-center">
                <div class="mb-4 md:mb-0">Conçu et développé avec <span class="text-red-500">♥</span> par 
                    <a class="hover:underline text-gray-600 italic" href="https://twitter.com/saleh_mirnezami">Hermanno18</a>.
                </div>
